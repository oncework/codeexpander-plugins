...
export const getDynamicDates = () => {
  ...
  const dates: { id: string; date: Date }[] = [
    { id: 'Now', date: now },
    { id: '1HourAgo', date: new Date(now.getTime() - 3600000) },
    { id: '1DayAgo', date: new Date(now.getTime() - 86400000) },
    { id: '1WeekAgo', date: new Date(now.getTime() - 604800000) },
    { id: '1MonthAgo', date: new Date(now.getTime() - 2592000000) },
    { id: 'NextHour', date: new Date(now.getTime() + 3600000) },
    { id: 'NextDay', date: new Date(now.getTime() + 86400000) },
    { id: 'NextWeek', date: new Date(now.getTime() + 604800000) },
    { id: 'NextMonth', date: new Date(now.getTime() + 2592000000) }
  ];
