...
const ColorConverter = () => {
  ...
  const convertColor = () => {
    try {
      ...
      showErrorToast(t("common.error"), t("colorConverter.errorInvalid"));
    }
  };
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>{t("colorConverter.title")}</CardTitle>
          </div>
          <CardDescription>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
            <div className="space-y-2">
              <Label htmlFor="color-input">{t("colorConverter.inputLabel")}</Label>
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-sm text-slate-600 dark:text-slate-400">{t("colorConverter.preview")}</div>
          </div>
          {Object.keys(results).length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">{t("colorConverter.resultsTitle")}</h3>
