...
const DateTimeConverter = () => {
  ...
  const handleDateTimeSelect = () => {
    ...
    showToast(t("dateTimeConverter.toastUpdated"));
  };
  ...
  const handleConvert = () => {
    try {
      ...
      showToast(t("dateTimeConverter.toastSuccess"));
    } catch {
      showErrorToast(t("common.error"), t("dateTimeConverter.errorInvalid"));
    }
  };
  ...
  const setCurrentTime = () => {
    ...
    showToast(t("dateTimeConverter.toastSetCurrent"));
  };
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>{t("dateTimeConverter.title")}</CardTitle>
          </div>
          <CardDescription>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
            ...
            <Button onClick={handleDateTimeSelect} disabled={!selectedDate} className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={exampleInputs[inputFormat]}
              />
            </div>
            <div className="space-y-2">
          ...
          {Object.keys(results).length > 0 && (
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                {Object.entries(results).map(([fmt, value]) => (
                  <div
                    key={fmt}
                    className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                  >
