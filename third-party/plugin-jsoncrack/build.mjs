...
const submoduleDir = join(__dirname, 'jsoncrack')

console.log('Installing dependencies...')
execSync('npm_config_engine_strict=false CI=true pnpm install --force', { cwd: submoduleDir, stdio: 'inherit' })

console.log('Building jsoncrack...')
execSync('CI=true pnpm run build', { cwd: submoduleDir, stdio: 'inherit' })

const sourceDir = join(__dirname, 'jsoncrack/out')
