      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t("htmlColorCodes.title")}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="picker" className="space-y-6">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="picker">{t("htmlColorCodes.pickerTab")}</TabsTrigger>
              <TabsTrigger value="named">{t("htmlColorCodes.namedTab")}</TabsTrigger>
            </TabsList>

            <TabsContent value="picker" className="space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="color-picker">{t("htmlColorCodes.pickLabel")}</Label>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">{t("htmlColorCodes.colorFormatsTitle")}</h3>
                ...
                <Card>
                  <CardContent className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => copyToClipboard(formats.hex)}
                        variant="outline"
                        size="sm"
                      >
                ...
                <Card>
                  <CardContent className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => copyToClipboard(formats.rgb)}
                        variant="outline"
                        size="sm"
                      >
                        <Copy className="h-3 w-3 mr-1" />
                ...
                <Card>
                  <CardContent className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => copyToClipboard(formats.rgba)}
                        variant="outline"
                        size="sm"
                      >
                        <Copy className="h-3 w-3 mr-1" />
                ...
                <Card>
                  <CardContent className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => copyToClipboard(formats.hsl)}
                        variant="outline"
                        size="sm"
                      >
                        <Copy className="h-3 w-3 mr-1" />
                ...
                <Card>
                  <CardContent className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => copyToClipboard(formats.hsla)}
                        variant="outline"
                        size="sm"
                      >
                        <Copy className="h-3 w-3 mr-1" />
