...
export const useSelectionTool = () => {
  ...
  const copySelection = useCallback((canvasRef: RefObject<HTMLCanvasElement>) => {
    ...
    showToast("Selection Copied: The selected area has been copied to clipboard and can be pasted.");
  }, [selectionArea, copyToClipboard]);
  ...
  const pasteSelection = useCallback((
    ...
    showToast("Selection Pasted: The copied content has been pasted. Click and drag to move it.");
  }, [copiedImageData]);
  ...
  const cutSelection = useCallback((
    ...
    showToast("Selection Cut: The selected area has been cut and copied to clipboard.");
  }, [selectionArea, copyToClipboard]);
