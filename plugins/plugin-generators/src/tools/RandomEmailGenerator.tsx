...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Button } from "@codeexpander/dev-tools-ui";
...
const RandomEmailGenerator = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6">
      <Card>
        <CardHeader>
          <CardTitle>{t("randomEmailGenerator.title")}</CardTitle>
          <CardDescription>
            {t("randomEmailGenerator.description")}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Button onClick={handleGenerate} className="w-full">
            ...
            {count > 1 ? t("randomEmailGenerator.generateBtnPlural") : t("randomEmailGenerator.generateBtn")}
          </Button>
